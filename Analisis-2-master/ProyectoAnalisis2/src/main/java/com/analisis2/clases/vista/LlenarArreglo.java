 ...
 */
public class LlenarArreglo extends javax.swing.JFrame {

    GrupoDeProductos grupo;
    float precio;
    
    public LlenarArreglo(GrupoDeProductos grupo, float precio) {
        initComponents();
        this.grupo = grupo;
        this.precio = precio;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nombre de arreglo:");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Ganancia del arreglo:");
        ...
        jLabel5.setText("Valor agregado de productos:");
        ...
        jLabel3.setText("Llenar datos de arreglo:");

        jButton1.setText("Guardar Arreglo");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        float ganancia = Float.parseFloat(jTextField2.getText());
        int existencia = Integer.parseInt(jTextField3.getText());
        
        ganancia = ganancia + precio;
        
        IncersionArreglo i = new IncersionArreglo(grupo, grupo.getPrecio());
        i.crearArreglo(nombre, ganancia, existencia);
